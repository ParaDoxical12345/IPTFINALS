...
<div class="bg-gray-50 p-8 rounded-md w-full ">
	<div class=" flex items-center justify-between pb-6">
            <div>
                <h2 class="text-gray-600 font-semibold">List of Payrolls</h2>
                <span class="text-xs">All payrolls </span>
            </div>
            <div class="flex items-center justify-between">
                <div class="lg:ml-40 ml-10 space-x-8">
                    ...
                    @endif
                    <a href="/payroll/create" type="button" class="bg-green-500 px-4 py-2 rounded-md text-white font-normal tracking-wide cursor-pointer">
                        <i class="fa-solid fa-user-plus"></i> Create Payroll
                    </a>
