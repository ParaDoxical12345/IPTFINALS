...
<div class="h-screen bg-gray-50 p-5 flex justify-center items-center">
	<div class="lg:w-2/5 md:w-1/2 w-2/3">
        <form  method="POST" action="{{ route('employee.store') }}" class="bg-white p-10 rounded-lg shadow-lg min-w-full px-10 ">
            {{csrf_field()}}
            <h1 class="text-center text-2xl mb-6 text-green-600 font-bold font-sans">Create Employee</h1>
            <div class="flex -mx-3">
            ...
            <button type="submit" class="w-full mt-6 bg-green-600 rounded-lg px-4 py-2 text-lg text-white tracking-wide font-semibold font-sans mb-5">Create Employee</button>
		</form>
	</div>
</div>
