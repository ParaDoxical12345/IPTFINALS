...
<!-- component -->
    <div class="bg-gray-50 p-8 rounded-md w-full ">
        <div class=" flex items-center justify-between pb-6">
            <div>
                <h2 class="text-gray-600 font-semibold">List of Employees</h2>
            ...
            <div class="flex items-center justify-between">
                <div class="lg:ml-40 ml-10 space-x-8 justify-between">
                    ...
                    <a href="/employees/create" type="button" class="bg-green-500 px-4 py-2 rounded-md text-white font-normal tracking-wide cursor-pointer" >
                        <i class="fa-solid fa-user-plus"></i> Create Employee
                    </a>
                    {{-- <button class="bg-green-500 px-4 py-2 rounded-md text-white font-normal tracking-wide cursor-pointer">Create Employee</button> --}}
                </div>
            </div>
        </div>
                            ...
                            @foreach($employees as $emp)
                                <tr>
                                    ...
                                    <td class="px-5 py-5 bg-white text-sm">
                                        <p class="text-gray-900 whitespace-no-wrap">{{$emp->user->firstName}} {{$emp->user->lastName}}</p>
                                    </td>
                                    <td class="px-5 py-5 bg-white text-sm">
                                        <p class="text-gray-900 whitespace-no-wrap">{{$emp->user->email}}</p>
                                    </td>
                                    <td class="px-5 py-5 bg-white text-sm">
                                        <p class="text-gray-900 whitespace-no-wrap">{{$emp->position->position}}</p>
                                    </td>
                                    <td class="px-5 py-5 bg-white text-sm">
                                        <p class="text-gray-900 whitespace-no-wrap">{{$emp->user->address}}</p>
                                    </td>
                                    <td class="px-5 py-5 bg-white text-sm">
                                        <p class="text-gray-900 whitespace-no-wrap">{{$emp->user->phone}}</p>
                                    </td>
                                    <td class="px-5 py-5 bg-white text-sm">
